...
export const PERMISSION_GROUP_LABEL_KEYS = {
    ...
    cash: 'role.permission-group.cash',
...
const SLUG_TO_GROUP = {
    ...
    manage_cash_control: 'cash',
    view_own_cash_session: 'cash',
    create_cash_income: 'cash',
    create_cash_expense: 'cash',
    withdraw_cash: 'cash',
    view_cash_supervision: 'cash',
    view_cash_closures: 'cash',
    manage_cash_registers: 'cash',
    reverse_cash_movement: 'cash',
    transfer_cash: 'cash',
    review_cash_closure: 'cash',

    manage_suppliers: 'people',
    manage_customers: 'people',
    manage_users: 'people',
    change_user_passwords: 'people',
    change_customer_passwords: 'people',
