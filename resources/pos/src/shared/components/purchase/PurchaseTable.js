            ...
            <tr key={index} className="align-middle text-nowrap">
                ...
                <td>
                    {singleProduct.isEdit ? (
                        ...
                        // vez).
                        const warehouseEntry = singleProduct.warehouseStock?.find(
                            (w) => String(w.warehouse_id) === String(selectedWarehouseId)
                        );
                        const qty = warehouseEntry ? warehouseEntry.total_quantity : 0;
