...
export const asideStyles = `
  ...
  .aside-menu-container .pro-sidebar-inner {
    ...
    box-shadow: 4px 0 24px rgba(47, 111, 237,0.06) !important;
  ...
  .aside-menu-container .sidebar-btn:hover { background: #E2E8F0 !important; }
  .aside-menu-container .sidebar-btn .svg-inline--fa { color: #2F6FED !important; font-size: 14px !important; }
  ...
  .aside-menu-container .pro-menu-item.pro-active-sub > .pro-inner-item {
    ...
    color: #fff !important;
    border-radius: 10px !important;
    box-shadow: 0 4px 14px rgba(47, 111, 237,0.2) !important;
  }
