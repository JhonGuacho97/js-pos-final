...
import { faEdit, faEye, faTrash, faTags, faStore } from "@fortawesome/free-solid-svg-icons";
...
const ProductDetail = (props) => {
    ...
    const [warehousePriceProductId, setWarehousePriceProductId] = useState(null);
                                    ...
                                    <td className="py-4">
                                        <div className="text-center">
                                            ...
                                            {product.attributes.product_type == 1 &&
                                                <button title="Presentaciones de venta"
                                            ...
                                            <button title="Precio por sucursal"
