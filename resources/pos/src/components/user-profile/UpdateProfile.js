                    ...
                    <div className="card-body">
                        ...
                        <div className="profile-header">
                            <div className="profile-avatar-wrap">
                                {imagePreviewUrl && typeof imagePreviewUrl === 'string' && imagePreviewUrl.startsWith('data:') || (imagePreviewUrl && imagePreviewUrl !== avtarName) ? (
                                    <img
                                        ...
                                        alt="avatar"
                                        style={{ width: 80, height: 80, borderRadius: '50%', objectFit: 'cover', border: '3px solid #fff', boxShadow: '0 4px 16px rgba(47, 111, 237,0.2)' }}
                                    />
                                ) : (
                                    <div style={{
                            ...
                            <div>
                                ...
                                <p style={{ fontSize: 13, color: '#64748B', margin: 0, fontWeight: 500, fontFamily: 'Poppins, sans-serif' }}>
