...
<table width="100%">
    <tr>
        <td align="" style="vertical-align: bottom">
            <h2 style="color: #1f2937;">{{ getLoginUserLanguage() == 'cn' ? 'Payment List' : __('messages.pdf.payment_list') }}</h2>
        </td>
    </tr>
</table>
<table width="100%" cellspacing="0" cellpadding="10" style="margin-top: 40px;">
    ...
    <tr style="background-color: #f8f9fa; border-bottom: 2px solid #1f2937;">
        ...
        <th style="color: #1f2937; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em; font-size: 11px;">{{ getLoginUserLanguage() == 'cn' ? 'Sale Reference' : __('messages.pdf.sale_reference') }}</th>
        ...
        <th style="color: #1f2937; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em; font-size: 11px;">{{ getLoginUserLanguage() == 'cn' ? 'Payment Type' : __('messages.pdf.payment_type') }}</th>
    </tr>
    </thead>
