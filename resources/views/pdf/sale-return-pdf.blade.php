...
<table width="100%">
    <tr>
        ...
        <td align="center" style="vertical-align: bottom">
            <h2 style="color: #1f2937;">{{ $saleReturn->reference_code }}</h2>
        </td>
        ...
        <td style="width: 50%;">
            <table width="95%" cellpadding="0">
                <tr style="background-color: #f8f9fa; border-bottom: 2px solid #1f2937;">
                    <td style="color: #1f2937; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em; font-size: 11px;padding: 10px;font-size: 18px;">{{ getLoginUserLanguage() == 'cn' ? 'Customer Info' : __('messages.pdf.customer_info') }}</td>
                </tr>
...
<table width="100%" cellspacing="0" cellpadding="10" style="margin-top: 40px;">
    ...
    <tr style="background-color: #f8f9fa; border-bottom: 2px solid #1f2937;">
        ...
        <th style="color: #1f2937; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em; font-size: 11px;">{{ getLoginUserLanguage() == 'cn' ? 'UNIT PRICE' : __('messages.pdf.unit_price') }}</th>
