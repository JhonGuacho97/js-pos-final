    ...
    <table width="100%">
        <tr>
            <td align="center" style="vertical-align: bottom">
                <h2 style="color: #1f2937;">Client : {{ $customer->name }}</h2>
            </td>
        </tr>
    </table>
            ...
            <td style="width: 50%;">
                <table width="95%" cellpadding="0">
                    <tr style="background-color: #f8f9fa; border-bottom: 2px solid #1f2937;">
                        <td style="color: #1f2937; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em; font-size: 11px;padding: 10px;font-size: 18px;">
    ...
    <table width="100%" cellspacing="0" cellpadding="10" style="margin-top: 40px;">
        <thead>
            <tr style="background-color: #f8f9fa; border-bottom: 2px solid #1f2937;">
                ...
                <th style="color: #1f2937; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em; font-size: 11px;">
                    {{ getLoginUserLanguage() == 'cn' ? 'Reference' : __('messages.pdf.reference') }}</th>
                <th style="color: #1f2937; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em; font-size: 11px;">
                    {{ getLoginUserLanguage() == 'cn' ? 'Paid Amount' : __('messages.pdf.paid_amount') }}</th>
                <th style="color: #1f2937; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em; font-size: 11px;">
                    {{ getLoginUserLanguage() == 'cn' ? 'Due Amount' : __('messages.pdf.due_amount') }}</th>
                <th style="color: #1f2937; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em; font-size: 11px;">
                    {{ getLoginUserLanguage() == 'cn' ? 'Payment Status' : __('messages.pdf.payment_status') }}</th>
            </tr>
        </thead>
        <tbody style="background-color: #f5f3f3;">
