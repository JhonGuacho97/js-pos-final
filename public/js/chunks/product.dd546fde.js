...
/***/ "./resources/pos/src/components/productKits/ProductKits.js"
/*!*****************************************************************!*\
  !*** ./resources/pos/src/components/productKits/ProductKits.js ***!
  \*****************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _assets_images_brand_logo_png__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../assets/images/brand_logo.png */ "./resources/pos/src/assets/images/brand_logo.png");
/* harmony import */ var _store_action_productAction__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../store/action/productAction */ "./resources/pos/src/store/action/productAction.js");
/* harmony import */ var _store_action_brandsAction__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../store/action/brandsAction */ "./resources/pos/src/store/action/brandsAction.js");
/* harmony import */ var _store_action_productCategoryAction__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../store/action/productCategoryAction */ "./resources/pos/src/store/action/productCategoryAction.js");
...
var TAX_TYPES = [{
  value: "1",
  label: "Exclusivo (no incluye IVA)"
}, {
  value: "2",
  label: "Inclusivo (ya incluye IVA)"
}];
var COMPONENTES_VISIBLES_EN_TABLA = 2;
var emptyForm = function emptyForm() {
  return {
    ...
    components: [{
      ...
      component_product_presentation_id: null,
      quantity: "1"
    }]
  };
};
var ProductKits = function ProductKits(props) {
  var _TAX_TYPES$find, _productCategories$fi, _brands$find, _baseUnits$find;
  var products = props.products,
    brands = props.brands,
    productCategories = props.productCategories,
  ...
  var _useState9 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(emptyForm()),
    _useState0 = _slicedToArray(_useState9, 2),
    form = _useState0[0],
    setForm = _useState0[1];
  var _useState1 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({}),
    _useState10 = _slicedToArray(_useState1, 2),
    errores = _useState10[0],
    setErrores = _useState10[1];
  ...
  var _useState13 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null),
    _useState14 = _slicedToArray(_useState13, 2),
    imagenPreviewUrl = _useState14[0],
    setImagenPreviewUrl = _useState14[1];
  var _useState15 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    _useState16 = _slicedToArray(_useState15, 2),
    guardando = _useState16[0],
    setGuardando = _useState16[1];
  var _useState17 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null),
    _useState18 = _slicedToArray(_useState17, 2),
    kitAEliminar = _useState18[0],
    setKitAEliminar = _useState18[1];
  ...
  var _useState19 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
    _useState20 = _slicedToArray(_useState19, 2),
    baseUnits = _useState20[0],
    setBaseUnits = _useState20[1];
  var cargarKits = function cargarKits() {
    setCargando(true);
    _config_apiConfig__WEBPACK_IMPORTED_MODULE_6__["default"].get("/product-kits").then(function (res) {
      return setKits(res.data.data || []);
    })["finally"](function () {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    fetchAllBrands();
    fetchAllProductCategories();
    _config_apiConfig__WEBPACK_IMPORTED_MODULE_6__["default"].get("/base-units?page[size]=0").then(function (res) {
      return setBaseUnits(res.data.data || []);
    });
    cargarKits();
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []);
  var abrirNuevo = function abrirNuevo() {
    setForm(emptyForm());
    setErrores({});
    setImagen(null);
  ...
  var abrirEditar = function abrirEditar(kit) {
    var _kit$images;
    setForm({
      id: kit.id,
      name: kit.name,
      ...
      components: (kit.kit_items || []).map(function (it) {
        return {
    ...
    setErrores({});
    setImagen(null);
    setImagenPreviewUrl(((_kit$images = kit.images) === null || _kit$images === void 0 || (_kit$images = _kit$images.imageUrls) === null || _kit$images === void 0 ? void 0 : _kit$images[0]) || null);
    setShowForm(true);
  };
  var setCampo = function setCampo(campo, valor) {
    setForm(function (f) {
      return _objectSpread(_objectSpread({}, f), {}, _defineProperty({}, campo, valor));
    });
    setErrores(function (e) {
      return _objectSpread(_objectSpread({}, e), {}, _defineProperty({}, campo, undefined));
    });
  };
  var onImagenChange = function onImagenChange(e) {
    var _e$target$files;
  ...
  var agregarComponente = function agregarComponente() {
    setForm(function (f) {
      return _objectSpread(_objectSpread({}, f), {}, {
        components: [].concat(_toConsumableArray(f.components), [{
          component_product_id: null,
          component_product_presentation_id: null,
          quantity: "1"
        }])
  ...
  var quitarComponente = function quitarComponente(idx) {
    setForm(function (f) {
      return _objectSpread(_objectSpread({}, f), {}, {
        components: f.components.filter(function (_, i) {
          return i !== idx;
        })
      });
    });
  ...
  var onComponenteChange = function onComponenteChange(idx, campo, valor) {
    setForm(function (f) {
      return _objectSpread(_objectSpread({}, f), {}, {
        components: f.components.map(function (c, i) {
          if (i !== idx) return c;
          // Si cambia el producto, la presentación elegida antes ya
          // no aplica (era de otro producto).
          if (campo === "component_product_id") {
            return _objectSpread(_objectSpread({}, c), {}, {
              component_product_id: valor,
              component_product_presentation_id: null
            });
          }
          return _objectSpread(_objectSpread({}, c), {}, _defineProperty({}, campo, valor));
        })
      });
    });
    setErrores(function (e) {
  ...
  var validarCampos = function validarCampos() {
    ...
    if (form.components.length < 1) {
      ...
      var componenteInvalido = form.components.find(function (c) {
        return !c.component_product_id || !c.quantity || Number(c.quantity) <= 0;
      });
      if (componenteInvalido) {
        errs.components = !componenteInvalido.component_product_id ? "Hay un componente sin producto seleccionado." : "Hay un componente con cantidad inválida.";
      } else {
        var ids = form.components.map(function (c) {
          return c.component_product_id;
        });
  ...
  var guardar = function guardar() {
    var errs = validarCampos();
    setErrores(errs);
    var primerError = Object.values(errs)[0];
    if (primerError) {
    ...
    formData.append("components", JSON.stringify(form.components.map(function (c) {
      return {
    ...
    var url = form.id ? "/product-kits/".concat(form.id) : "/product-kits";
    _config_apiConfig__WEBPACK_IMPORTED_MODULE_6__["default"].post(url, formData, {
      headers: {
        "Content-Type": "multipart/form-data"
      }
    }).then(function () {
      dispatch((0,_store_action_toastAction__WEBPACK_IMPORTED_MODULE_16__.addToast)({
        text: form.id ? "Kit actualizado correctamente." : "Kit creado correctamente."
      }));
      setShowForm(false);
      cargarKits();
      ...
      var _error$response;
      dispatch((0,_store_action_toastAction__WEBPACK_IMPORTED_MODULE_16__.addToast)({
        text: (error === null || error === void 0 || (_error$response = error.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || "No se pudo guardar el kit.",
        type: _constants__WEBPACK_IMPORTED_MODULE_17__.toastType.ERROR
      }));
    })["finally"](function () {
  ...
  var confirmarEliminar = function confirmarEliminar() {
    _config_apiConfig__WEBPACK_IMPORTED_MODULE_6__["default"]["delete"]("/product-kits/".concat(kitAEliminar.id)).then(function () {
      dispatch((0,_store_action_toastAction__WEBPACK_IMPORTED_MODULE_16__.addToast)({
        text: "Kit eliminado correctamente."
      }));
      cargarKits();
    })["catch"](function (error) {
      var _error$response2;
      dispatch((0,_store_action_toastAction__WEBPACK_IMPORTED_MODULE_16__.addToast)({
        text: (error === null || error === void 0 || (_error$response2 = error.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || "No se pudo eliminar el kit.",
        type: _constants__WEBPACK_IMPORTED_MODULE_17__.toastType.ERROR
      }));
    })["finally"](function () {
      return setKitAEliminar(null);
    });
  };
  var nombreProducto = function nombreProducto(id) {
    var _products$find;
    return ((_products$find = products.find(function (p) {
      return +p.id === +id;
    })) === null || _products$find === void 0 || (_products$find = _products$find.attributes) === null || _products$find === void 0 ? void 0 : _products$find.name) || "#".concat(id);
  };
  var kitsFiltrados = kits.filter(function (kit) {
    var _kit$name, _kit$code;
    var q = busqueda.trim().toLowerCase();
    if (!q) return true;
    return ((_kit$name = kit.name) === null || _kit$name === void 0 ? void 0 : _kit$name.toLowerCase().includes(q)) || ((_kit$code = kit.code) === null || _kit$code === void 0 ? void 0 : _kit$code.toLowerCase().includes(q));
  });
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)(_MasterLayout__WEBPACK_IMPORTED_MODULE_7__["default"], {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("span", {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__.FontAwesomeIcon, {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("h4", {
            className: "mb-0",
            children: "Kits de Productos"
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("div", {
            className: "text-muted small",
            children: "Combin\xE1 productos reales en un solo \xEDtem vendible desde el POS."
          })]
        })]
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
          ...
          }), !cargando && kits.length > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("span", {
            className: "badge bg-light-primary text-primary fs-small px-3 py-2",
            children: [kits.length, " ", kits.length === 1 ? "kit" : "kits"]
          })]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("div", {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("table", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("thead", {
              ...
              children: [cargando && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("tr", {
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("td", {
                  colSpan: 5,
                  children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_shared_components_loaders_Spinner__WEBPACK_IMPORTED_MODULE_11__["default"], {})
                })
              }), !cargando && kits.length === 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("tr", {
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("td", {
                  colSpan: 5,
                  ...
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__.FontAwesomeIcon, {
                    ...
                    className: "fw-bold",
                    children: "Todav\xEDa no creaste ning\xFAn kit"
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("div", {
                    className: "text-muted small mb-3",
                    children: "Combin\xE1 productos reales (ej: cerveza + michelada) en un solo producto vendible."
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("button", {
              ...
              }), !cargando && kits.length > 0 && kitsFiltrados.length === 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("tr", {
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("td", {
                  colSpan: 5,
                  className: "text-center text-muted py-4",
                  children: ["No se encontraron kits para \"", busqueda, "\"."]
                })
              }), kitsFiltrados.map(function (kit) {
                var _kit$images2;
                return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("tr", {
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("td", {
                    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("img", {
                      src: ((_kit$images2 = kit.images) === null || _kit$images2 === void 0 || (_kit$images2 = _kit$images2.imageUrls) === null || _kit$images2 === void 0 ? void 0 : _kit$images2[0]) || _assets_images_brand_logo_png__WEBPACK_IMPORTED_MODULE_12__["default"],
                      alt: kit.name,
                      className: "border",
                      style: {
                        width: 44,
                    ...
                    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
                      className: "fw-bold",
                      children: ["$", Number(kit.product_price || 0).toFixed(2)]
                    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("div", {
                      className: "text-muted small",
                      children: String(kit.tax_type) === "2" ? "IVA incluido" : "+ IVA ".concat(kit.order_tax || 0, "%")
                    })]
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("td", {
                    children: [(kit.kit_items || []).slice(0, COMPONENTES_VISIBLES_EN_TABLA).map(function (it) {
                      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("span", {
                        className: "badge bg-light-primary text-primary me-1 mb-1",
                        children: [it.quantity, " \xD7 ", it.component_name, it.component_presentation_name ? " (".concat(it.component_presentation_name, ")") : ""]
                      }, it.id);
                    }), (kit.kit_items || []).length > COMPONENTES_VISIBLES_EN_TABLA && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("span", {
                      className: "badge bg-light-secondary text-secondary mb-1",
                      children: ["+", kit.kit_items.length - COMPONENTES_VISIBLES_EN_TABLA, " m\xE1s"]
                    })]
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("td", {
                    className: "text-end",
                    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_shared_action_buttons_ActionButton__WEBPACK_IMPORTED_MODULE_10__["default"], {
                      item: kit,
    ...
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_2__["default"], {
      show: showForm,
      onHide: function onHide() {
      ...
      centered: true,
      backdrop: "static",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_2__["default"].Header, {
        closeButton: true,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_2__["default"].Title, {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__.FontAwesomeIcon, {
            icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_5__.faGift,
            className: "me-2 text-primary"
          }), form.id ? "Editar Kit" : "Nuevo Kit"]
        })
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_2__["default"].Body, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
          className: "row g-3 mb-1",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("div", {
            className: "col-md-3 text-center",
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_shared_image_picker_ImagePicker__WEBPACK_IMPORTED_MODULE_9__["default"], {
              imagePreviewUrl: imagenPreviewUrl,
              handleImageChange: onImagenChange,
              user: _assets_images_brand_logo_png__WEBPACK_IMPORTED_MODULE_12__["default"],
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
              ...
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("label", {
                  ...
                  value: form.name,
                  onChange: function onChange(e) {
                    return setCampo("name", e.target.value);
                  },
                  placeholder: "Ej: \"Pack Cerveza + Michelada\""
                }), errores.name && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("span", {
                  className: "text-danger d-block fw-400 fs-small mt-2",
                  children: errores.name
                })]
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
                className: "col-md-4",
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("label", {
                  ...
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("span", {
                    ...
                    onChange: function onChange(e) {
                      return setCampo("product_price", e.target.value);
                    }
                  })]
                }), errores.product_price && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("span", {
                  className: "text-danger d-block fw-400 fs-small mt-2",
                  children: errores.product_price
                })]
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
                className: "col-md-4",
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("label", {
                  ...
                  onChange: function onChange(e) {
                    return setCampo("order_tax", e.target.value);
                  }
                })]
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("div", {
                className: "col-md-4",
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_shared_select_reactSelect__WEBPACK_IMPORTED_MODULE_8__["default"], {
                  title: "Tipo de Impuesto",
                  multiLanguageOption: TAX_TYPES.map(function (t) {
                    return {
                      id: t.value,
                      name: t.label
                    };
                  ...
                  value: {
                    value: form.tax_type,
                    label: (_TAX_TYPES$find = TAX_TYPES.find(function (t) {
                      return t.value === form.tax_type;
                    })) === null || _TAX_TYPES$find === void 0 ? void 0 : _TAX_TYPES$find.label
                  },
                  onChange: function onChange(obj) {
                    return setCampo("tax_type", (obj === null || obj === void 0 ? void 0 : obj.value) || "1");
                  },
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("div", {
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_shared_select_reactSelect__WEBPACK_IMPORTED_MODULE_8__["default"], {
              ...
              value: form.product_category_id ? {
                value: form.product_category_id,
                label: (_productCategories$fi = productCategories.find(function (c) {
                  return +c.id === +form.product_category_id;
                })) === null || _productCategories$fi === void 0 || (_productCategories$fi = _productCategories$fi.attributes) === null || _productCategories$fi === void 0 ? void 0 : _productCategories$fi.name
              } : null,
              onChange: function onChange(obj) {
                return setCampo("product_category_id", (obj === null || obj === void 0 ? void 0 : obj.value) || null);
              },
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_shared_select_reactSelect__WEBPACK_IMPORTED_MODULE_8__["default"], {
              ...
              value: form.brand_id ? {
                value: form.brand_id,
                label: (_brands$find = brands.find(function (b) {
                  return +b.id === +form.brand_id;
                })) === null || _brands$find === void 0 || (_brands$find = _brands$find.attributes) === null || _brands$find === void 0 ? void 0 : _brands$find.name
              } : null,
              onChange: function onChange(obj) {
                return setCampo("brand_id", (obj === null || obj === void 0 ? void 0 : obj.value) || null);
              },
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_shared_select_reactSelect__WEBPACK_IMPORTED_MODULE_8__["default"], {
              ...
              value: form.product_unit ? {
                value: form.product_unit,
                label: (_baseUnits$find = baseUnits.find(function (u) {
                  return +u.id === +form.product_unit;
                })) === null || _baseUnits$find === void 0 || (_baseUnits$find = _baseUnits$find.attributes) === null || _baseUnits$find === void 0 ? void 0 : _baseUnits$find.name
              } : null,
              onChange: function onChange(obj) {
                return setCampo("product_unit", (obj === null || obj === void 0 ? void 0 : obj.value) || null);
              },
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("h6", {
              ...
              className: "text-muted small",
              children: "Qu\xE9 productos reales se descuentan del stock al vender 1 unidad de este kit."
            })]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("span", {
            className: "badge bg-light-primary text-primary",
            children: [form.components.length, " ", form.components.length === 1 ? "componente" : "componentes"]
          })]
        }), errores.components && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
          className: "alert alert-danger py-2 px-3 small mb-2",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__.FontAwesomeIcon, {
            icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_5__.faTriangleExclamation,
            className: "me-2"
          }), errores.components]
        }), form.components.map(function (comp, idx) {
          var _productoSeleccionado, _productoSeleccionado2;
          var productoSeleccionado = comp.component_product_id ? products.find(function (p) {
            return +p.id === +comp.component_product_id;
          }) : null;
          var presentaciones = productoSeleccionado !== null && productoSeleccionado !== void 0 && (_productoSeleccionado = productoSeleccionado.attributes) !== null && _productoSeleccionado !== void 0 && _productoSeleccionado.manage_presentations ? productoSeleccionado.attributes.presentations || [] : [];
          var tienePresentaciones = presentaciones.length > 0;
          var presentacionSeleccionada = comp.component_product_presentation_id ? presentaciones.find(function (p) {
            return +p.id === +comp.component_product_presentation_id;
          }) : null;
          var stockDisponible = productoSeleccionado === null || productoSeleccionado === void 0 || (_productoSeleccionado2 = productoSeleccionado.attributes) === null || _productoSeleccionado2 === void 0 ? void 0 : _productoSeleccionado2.in_stock;
          var equivalencia = (presentacionSeleccionada === null || presentacionSeleccionada === void 0 ? void 0 : presentacionSeleccionada.equivalence) || 1;
          var unidadesBase = comp.quantity && !isNaN(Number(comp.quantity)) ? Number(comp.quantity) * equivalencia : null;
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
            className: "row g-2 mb-2 align-items-center border rounded p-2 mx-0",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
              className: tienePresentaciones ? "col-md-5" : "col-md-7",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_shared_select_reactSelect__WEBPACK_IMPORTED_MODULE_8__["default"], {
                data: products,
                value: comp.component_product_id ? {
                  value: comp.component_product_id,
                  label: nombreProducto(comp.component_product_id)
                } : null,
                onChange: function onChange(obj) {
                  return onComponenteChange(idx, "component_product_id", (obj === null || obj === void 0 ? void 0 : obj.value) || null);
                },
                placeholder: "Buscar producto..."
              }), productoSeleccionado ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
                className: "text-muted small mt-1",
                children: ["Stock actual: ", stockDisponible !== null && stockDisponible !== void 0 ? stockDisponible : "—", " unidades"]
              }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("div", {
                className: "text-muted small mt-1",
                children: "Sin producto seleccionado"
              })]
            }), tienePresentaciones && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
              className: "col-md-2",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_shared_select_reactSelect__WEBPACK_IMPORTED_MODULE_8__["default"], {
                data: presentaciones.map(function (p) {
                  return {
                    value: p.id,
                    label: "".concat(p.name).concat(p.is_base_unit ? " (base)" : "")
                  };
                }),
                value: presentacionSeleccionada ? {
                  value: presentacionSeleccionada.id,
                  label: presentacionSeleccionada.name
                } : null,
                onChange: function onChange(obj) {
                  return onComponenteChange(idx, "component_product_presentation_id", (obj === null || obj === void 0 ? void 0 : obj.value) || null);
                },
                placeholder: "Presentaci\xF3n"
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("div", {
                className: "text-muted small mt-1",
              ...
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("input", {
                ...
                value: comp.quantity,
                onChange: function onChange(e) {
                  return onComponenteChange(idx, "quantity", e.target.value);
                }
              }), presentacionSeleccionada && unidadesBase !== null && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("div", {
                className: "text-muted small mt-1",
                children: ["= ", unidadesBase, " unidades base"]
              })]
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("div", {
              className: "col-md-2",
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_2__["default"].Footer, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("button", {
          ...
          onClick: guardar,
          disabled: guardando,
          children: guardando ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.Fragment, {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("span", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__.FontAwesomeIcon, {
              icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_5__.faFloppyDisk,
              className: "me-2"
            }), "Guardar Kit"]
          })
        })]
      })]
    }), kitAEliminar && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)((react_bootstrap_sweetalert__WEBPACK_IMPORTED_MODULE_3___default()), {
      custom: true,
      confirmBtnBsStyle: "danger mb-3 fs-5 rounded",
      cancelBtnBsStyle: "secondary mb-3 fs-5 rounded text-white",
      confirmBtnText: "S\xED, eliminar",
      cancelBtnText: "Cancelar",
      title: "\xBFEliminar este kit?",
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("span", {
        ...
        children: ["Se va a eliminar el kit \"", kitAEliminar.name, "\". Esta acci\xF3n no se puede deshacer."]
      })
    })]
  });
};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_redux__WEBPACK_IMPORTED_MODULE_1__.connect)(mapStateToProps, {
  fetchAllProducts: _store_action_productAction__WEBPACK_IMPORTED_MODULE_13__.fetchAllProducts,
  fetchAllBrands: _store_action_brandsAction__WEBPACK_IMPORTED_MODULE_14__.fetchAllBrands,
  fetchAllProductCategories: _store_action_productCategoryAction__WEBPACK_IMPORTED_MODULE_15__.fetchAllProductCategories
})(ProductKits));
