...
var EmailTemplateForm = function EmailTemplateForm(props) {
  ...
  var disabled = singleEmailTemplate && singleEmailTemplate[0].content === emailTemplateValue.content && (singleEmailTemplate[0].subject || '') === emailTemplateValue.subject;
  ...
  var tipoTemplate = singleEmailTemplate ? singleEmailTemplate[0].type : null;
  var variables = VARIABLES_POR_TIPO[tipoTemplate] || VARIABLES_POR_TIPO[1];
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("div", {
      ...
      style: {
        background: '#2F6FED',
        borderRadius: '0.475rem 0.475rem 0 0'
      },
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("h4", {
        className: "text-white mb-0",
        children: ["Formato Correo - ", emailTemplateValue.name || '...']
      })
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
      className: "card-body",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
        className: "alert alert-warning mb-4",
        children: ["Estimado usuario, tomar en consideraci\xF3n que aquellos campos que se encuentran entre llaves (", '{}', ") tanto en el Asunto como en el Contenido del correo ser\xE1n reemplazados por aquellos datos que indican su etiqueta."]
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(react_bootstrap_Form__WEBPACK_IMPORTED_MODULE_3__["default"], {
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
          className: "row",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("label", {
              ...
              type: "text",
              name: "subject",
              placeholder: "Ej: Documento Electr\xF3nico: {{NUMERO DE COMPROBANTE}}",
              ...
              className: "text-danger d-block fw-400 fs-small mt-2",
              children: errors['subject'] ? errors['subject'] : null
...
/***/ "./resources/pos/src/components/Email-templates/EmailTemplates.js"
/*!************************************************************************!*\
  !*** ./resources/pos/src/components/Email-templates/EmailTemplates.js ***!
  \************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _shared_action_buttons_ActionButton__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../shared/action-buttons/ActionButton */ "./resources/pos/src/shared/action-buttons/ActionButton.js");
...
/* harmony import */ var _store_action_emailTemplatesAction__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../store/action/emailTemplatesAction */ "./resources/pos/src/store/action/emailTemplatesAction.js");
...
var EmailTemplates = function EmailTemplates(props) {
  var totalRecord = props.totalRecord,
    isLoading = props.isLoading,
    emailTemplates = props.emailTemplates,
    fetchEmailTemplates = props.fetchEmailTemplates,
    activeInactiveEmail = props.activeInactiveEmail;
  ...
  var goToEditProduct = function goToEditProduct(item) {
    var id = item.id;
    navigate("/app/email-templates/".concat(id));
  };
  var itemsValue = emailTemplates.length >= 0 && emailTemplates.map(function (emailTemplate) {
    var _emailTemplate$attrib, _emailTemplate$attrib2;
    return {
      name: emailTemplate.attributes.template_name,
      content: emailTemplate.attributes.content,
      is_active: (emailTemplate === null || emailTemplate === void 0 || (_emailTemplate$attrib = emailTemplate.attributes) === null || _emailTemplate$attrib === void 0 ? void 0 : _emailTemplate$attrib.status) === 0 || (emailTemplate === null || emailTemplate === void 0 || (_emailTemplate$attrib2 = emailTemplate.attributes) === null || _emailTemplate$attrib2 === void 0 ? void 0 : _emailTemplate$attrib2.status) === false ? false : true,
      id: emailTemplate.id
    };
  });
  var columns = [{
    name: (0,_shared_sharedMethod__WEBPACK_IMPORTED_MODULE_6__.getFormattedMessage)('supplier.table.name.column.title'),
    ...
    name: (0,_shared_sharedMethod__WEBPACK_IMPORTED_MODULE_6__.getFormattedMessage)("purchase.select.status.label"),
    sortField: 'status',
    cell: function cell(row) {
      var content = row.content;
      var item = content.replace(/<\/?.+?>/ig, '');
    ...
    name: (0,_shared_sharedMethod__WEBPACK_IMPORTED_MODULE_6__.getFormattedMessage)("globally.input.content.label"),
    ...
    button: true,
    cell: function cell(row) {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_shared_action_buttons_ActionButton__WEBPACK_IMPORTED_MODULE_7__["default"], {
        item: row,
        isDeleteMode: false,
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)(_MasterLayout__WEBPACK_IMPORTED_MODULE_3__["default"], {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_shared_components_loaders_TopProgressBar__WEBPACK_IMPORTED_MODULE_8__["default"], {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_shared_tab_title_TabTitle__WEBPACK_IMPORTED_MODULE_5__["default"], {
      title: (0,_shared_sharedMethod__WEBPACK_IMPORTED_MODULE_6__.placeholderText)('email-template.title')
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_shared_table_ReactDataTable__WEBPACK_IMPORTED_MODULE_4__["default"], {
      columns: columns,
      items: itemsValue,
      onChange: onChange,
      isLoading: isLoading,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_redux__WEBPACK_IMPORTED_MODULE_1__.connect)(mapStateToProps, {
  fetchEmailTemplates: _store_action_emailTemplatesAction__WEBPACK_IMPORTED_MODULE_9__.fetchEmailTemplates,
  activeInactiveEmail: _store_action_emailTemplatesAction__WEBPACK_IMPORTED_MODULE_9__.activeInactiveEmail
})(EmailTemplates));
...
/***/ "./resources/pos/src/components/sms-templates/SmsTemplates.js"
/*!********************************************************************!*\
  !*** ./resources/pos/src/components/sms-templates/SmsTemplates.js ***!
  \********************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _shared_action_buttons_ActionButton__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../shared/action-buttons/ActionButton */ "./resources/pos/src/shared/action-buttons/ActionButton.js");
/* harmony import */ var _shared_components_loaders_TopProgressBar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../shared/components/loaders/TopProgressBar */ "./resources/pos/src/shared/components/loaders/TopProgressBar.js");
/* harmony import */ var _store_action_smsTemplatesAction__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../store/action/smsTemplatesAction */ "./resources/pos/src/store/action/smsTemplatesAction.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
...
var SmsTemplates = function SmsTemplates(props) {
  var totalRecord = props.totalRecord,
    isLoading = props.isLoading,
    smsTemplates = props.smsTemplates,
    fetchSmsTemplates = props.fetchSmsTemplates,
    activeInactiveSms = props.activeInactiveSms;
  var navigate = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_2__.useNavigate)();
  var onChange = function onChange(filter) {
  ...
  var goToEditProduct = function goToEditProduct(item) {
    var id = item.id;
    navigate("/app/sms-templates/".concat(id));
  };
  var itemsValue = smsTemplates.length >= 0 && smsTemplates.map(function (smsTemplate) {
    var _smsTemplate$attribut, _smsTemplate$attribut2;
    return {
      name: smsTemplate.attributes.template_name,
      content: smsTemplate.attributes.content,
      is_active: (smsTemplate === null || smsTemplate === void 0 || (_smsTemplate$attribut = smsTemplate.attributes) === null || _smsTemplate$attribut === void 0 ? void 0 : _smsTemplate$attribut.status) === 0 || (smsTemplate === null || smsTemplate === void 0 || (_smsTemplate$attribut2 = smsTemplate.attributes) === null || _smsTemplate$attribut2 === void 0 ? void 0 : _smsTemplate$attribut2.status) === false ? false : true,
      id: smsTemplate.id
    };
  });
  var columns = [{
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)(_MasterLayout__WEBPACK_IMPORTED_MODULE_3__["default"], {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_shared_components_loaders_TopProgressBar__WEBPACK_IMPORTED_MODULE_8__["default"], {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_shared_tab_title_TabTitle__WEBPACK_IMPORTED_MODULE_5__["default"], {
      title: (0,_shared_sharedMethod__WEBPACK_IMPORTED_MODULE_6__.placeholderText)('sms-template.title')
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_shared_table_ReactDataTable__WEBPACK_IMPORTED_MODULE_4__["default"], {
      columns: columns,
      items: itemsValue,
      onChange: onChange,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_redux__WEBPACK_IMPORTED_MODULE_1__.connect)(mapStateToProps, {
  fetchSmsTemplates: _store_action_smsTemplatesAction__WEBPACK_IMPORTED_MODULE_9__.fetchSmsTemplates,
  activeInactiveSms: _store_action_smsTemplatesAction__WEBPACK_IMPORTED_MODULE_9__.activeInactiveSms
})(SmsTemplates));
