...
/* harmony import */ var _SalesPresentationSelectModal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./SalesPresentationSelectModal */ "./resources/pos/src/shared/components/product-cart/search/SalesPresentationSelectModal.js");
/* harmony import */ var _PurchasePresentationSelectModal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./PurchasePresentationSelectModal */ "./resources/pos/src/shared/components/product-cart/search/PurchasePresentationSelectModal.js");
...
var ProductSearch = function ProductSearch(props) {
  ...
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null),
    _useState4 = _slicedToArray(_useState3, 2),
    presentationProduct = _useState4[0],
    setPresentationProduct = _useState4[1];
  var dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_1__.useDispatch)();
  var filterProducts = isAllProducts && values.warehouse_id ? products.map(function (item) {
    var _item$attributes$vari;
    return {
      name: item.attributes.name,
      code: item.attributes.code,
      id: item.id,
      variationLabel: ((_item$attributes$vari = item.attributes.variation_product) === null || _item$attributes$vari === void 0 ? void 0 : _item$attributes$vari.variation_type_name) || null
    };
    ...
    var _item$attributes$vari2;
    return {
      name: item.attributes.name,
      code: item.attributes.code,
      id: item.id,
      variationLabel: ((_item$attributes$vari2 = item.attributes.variation_product) === null || _item$attributes$vari2 === void 0 ? void 0 : _item$attributes$vari2.variation_type_name) || null
    };
  });
  var onProductSearch = function onProductSearch(code) {
    if (!values.warehouse_id) {
      ...
      var matchedProduct = products.find(function (item) {
        return item.attributes.code === code || item.attributes.code === code.code;
      });
      var newId = matchedProduct ? [matchedProduct.id] : [];
      ...
      if (finalId[0] !== undefined) {
        ...
        } else if (presentationMode && matchedProduct !== null && matchedProduct !== void 0 && (_matchedProduct$attri = matchedProduct.attributes) !== null && _matchedProduct$attri !== void 0 && _matchedProduct$attri.manage_presentations) {
  ...
  var onPresentationConfirm = function onPresentationConfirm(product, presentation, qty) {
    var baseLine = customProducts.find(function (item) {
      return item.product_id === product.id;
    });
    if (!baseLine) {
      return;
    }
    var newLine = _objectSpread(_objectSpread({}, baseLine), {}, {
    ...
    if (presentationMode === 'purchase') {
      var _ref, _presentation$effecti;
      var cost = (_ref = (_presentation$effecti = presentation.effective_cost) !== null && _presentation$effecti !== void 0 ? _presentation$effecti : presentation.cost) !== null && _ref !== void 0 ? _ref : 0;
      newLine.product_cost = cost;
      newLine.net_unit_cost = cost;
      newLine.fix_net_unit = cost;
    } else {
      var _ref2, _presentation$effecti2;
      var price = (_ref2 = (_presentation$effecti2 = presentation.effective_price) !== null && _presentation$effecti2 !== void 0 ? _presentation$effecti2 : presentation.price) !== null && _ref2 !== void 0 ? _ref2 : 0;
      newLine.product_price = price;
      newLine.net_unit_price = price;
      newLine.fix_net_unit = price;
    }
    setUpdateProducts([].concat(_toConsumableArray(updateProducts), [newLine]));
  ...
  var formatResult = function formatResult(item) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("span", {
      ...
      children: [item.code, " (", item.name, item.variationLabel ? " - ".concat(item.variationLabel) : "", ")"]
    });
  };
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(react_search_autocomplete__WEBPACK_IMPORTED_MODULE_2__.ReactSearchAutocomplete, {
      items: filterProducts,
      onSearch: handleOnSearch,
      inputSearchString: searchString,
      fuseOptions: {
        keys: ['code', 'name', 'variationLabel']
      },
      maxResults: 30,
      ...
      showIcon: false,
      showClear: false
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_7__.FontAwesomeIcon, {
    ...
    }), presentationMode === 'sale' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_SalesPresentationSelectModal__WEBPACK_IMPORTED_MODULE_9__["default"], {
      show: !!presentationProduct,
      onHide: function onHide() {
        return setPresentationProduct(null);
      },
      product: presentationProduct,
      onConfirm: onPresentationConfirm
    }), presentationMode === 'purchase' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_PurchasePresentationSelectModal__WEBPACK_IMPORTED_MODULE_10__["default"], {
      show: !!presentationProduct,
      onHide: function onHide() {
        return setPresentationProduct(null);
      },
...
/***/ "./resources/pos/src/shared/components/product-cart/search/PurchasePresentationSelectModal.js"
/*!****************************************************************************************************!*\
  !*** ./resources/pos/src/shared/components/product-cart/search/PurchasePresentationSelectModal.js ***!
  \****************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var PurchasePresentationSelectModal = function PurchasePresentationSelectModal(_ref) {
  var _attrs$product_unit_n;
  var show = _ref.show,
    onHide = _ref.onHide,
    product = _ref.product,
    onConfirm = _ref.onConfirm;
  var attrs = (product === null || product === void 0 ? void 0 : product.attributes) || {};
  var presentations = attrs.presentations || [];
  var defaultPresentation = presentations.find(function (p) {
    return p.is_default;
  }) || presentations[0];
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(defaultPresentation === null || defaultPresentation === void 0 ? void 0 : defaultPresentation.id),
    _useState2 = _slicedToArray(_useState, 2),
    selectedPresentationId = _useState2[0],
    setSelectedPresentationId = _useState2[1];
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(1),
    _useState4 = _slicedToArray(_useState3, 2),
    qty = _useState4[0],
    setQty = _useState4[1];
  var selectedPresentation = presentations.find(function (p) {
    return p.id === selectedPresentationId;
  });
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_3__["default"], {
    show: show,
    onHide: onHide,
    keyboard: true,
    centered: true,
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_3__["default"].Header, {
      closeButton: true,
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_3__["default"].Title, {
        children: attrs.name
      })
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_3__["default"].Body, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_4__["default"], {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
          className: "col-md-12 mb-4",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("label", {
            className: "form-label",
            children: [(0,_sharedMethod__WEBPACK_IMPORTED_MODULE_7__.getFormattedMessage)("product.input.sale-unit.label"), ":"]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
            className: "d-flex flex-wrap gap-2",
            children: presentations.map(function (presentation) {
              var _ref2, _presentation$effecti;
              var isSelected = selectedPresentationId === presentation.id;
              var cost = (_ref2 = (_presentation$effecti = presentation.effective_cost) !== null && _presentation$effecti !== void 0 ? _presentation$effecti : presentation.cost) !== null && _ref2 !== void 0 ? _ref2 : 0;
              return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
                ...
                children: [isSelected && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_5__.FontAwesomeIcon, {
                  ...
                  children: ["$ ", Number(cost).toFixed(2)]
                })]
              }, presentation.id);
            })
          })]
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("label", {
            className: "form-label",
            children: [(0,_sharedMethod__WEBPACK_IMPORTED_MODULE_7__.getFormattedMessage)("purchase.order-item.table.quantity.column.label"), ":"]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_2__["default"], {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_1__["default"], {
              variant: "light",
              onClick: function onClick() {
              ...
              onChange: function onChange(e) {
                return setQty(Number(e.target.value) || 1);
              }
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_1__["default"], {
              variant: "light",
              onClick: function onClick() {
                return setQty(function (q) {
                  return q + 1;
          ...
          }), selectedPresentation && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("small", {
            className: "text-muted d-block mt-1",
            children: [qty, " ", selectedPresentation.name, " =", " ", qty * selectedPresentation.equivalence, " ", (_attrs$product_unit_n = attrs.product_unit_name) === null || _attrs$product_unit_n === void 0 ? void 0 : _attrs$product_unit_n.name]
          })]
        })]
      })
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_3__["default"].Footer, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_1__["default"], {
        className: "btn btn-primary",
        disabled: !selectedPresentation || qty <= 0,
        onClick: handleConfirm,
        children: (0,_sharedMethod__WEBPACK_IMPORTED_MODULE_7__.getFormattedMessage)("globally.add-cart-btn")
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_1__["default"], {
        variant: "light",
        onClick: onHide,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PurchasePresentationSelectModal);

/***/ },

/***/ "./resources/pos/src/shared/components/product-cart/search/SalesPresentationSelectModal.js"
/*!*************************************************************************************************!*\
  !*** ./resources/pos/src/shared/components/product-cart/search/SalesPresentationSelectModal.js ***!
  \*************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var SalesPresentationSelectModal = function SalesPresentationSelectModal(_ref) {
  var _attrs$stock, _attrs$product_unit_n;
  var show = _ref.show,
    onHide = _ref.onHide,
    product = _ref.product,
    onConfirm = _ref.onConfirm;
  ...
  var availableUnits = ((_attrs$stock = attrs.stock) === null || _attrs$stock === void 0 ? void 0 : _attrs$stock.quantity) || 0;
  var maxQtyForPresentation = selectedPresentation ? Math.floor(availableUnits / selectedPresentation.equivalence) : 0;
  var handleConfirm = function handleConfirm() {
    if (!selectedPresentation || qty <= 0) return;
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_3__["default"].Header, {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_4__["default"], {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
            ...
            children: presentations.map(function (presentation) {
              ...
              return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
                ...
                children: [isSelected && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_5__.FontAwesomeIcon, {
                  ...
                  children: ["$ ", (_presentation$effecti = presentation.effective_price) !== null && _presentation$effecti !== void 0 ? _presentation$effecti : presentation.price]
                })]
              }, presentation.id);
            })
          })]
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("label", {
            ...
            className: "text-muted d-block mt-1",
            children: [qty, " ", selectedPresentation.name, " =", " ", qty * selectedPresentation.equivalence, " ", (_attrs$product_unit_n = attrs.product_unit_name) === null || _attrs$product_unit_n === void 0 ? void 0 : _attrs$product_unit_n.name]
          }), qty > maxQtyForPresentation && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("span", {
            className: "text-danger d-block fw-400 fs-small mt-2",
            children: (0,_sharedMethod__WEBPACK_IMPORTED_MODULE_7__.getFormattedMessage)("pos.quantity.exceeds.quantity.available.in.stock.message")
          })]
        })]
      })
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_3__["default"].Footer, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_1__["default"], {
        className: "btn btn-primary",
        disabled: !selectedPresentation || qty <= 0 || qty > maxQtyForPresentation,
        onClick: handleConfirm,
        children: (0,_sharedMethod__WEBPACK_IMPORTED_MODULE_7__.getFormattedMessage)("globally.add-cart-btn")
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(react_bootstrap_v5__WEBPACK_IMPORTED_MODULE_1__["default"], {
        variant: "light",
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SalesPresentationSelectModal);
